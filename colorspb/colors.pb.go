...
var fileDescriptor_a16566239bd98cfd = []byte{
	...
	0xd5, 0x46, 0x0b, 0x18, 0xa1, 0xde, 0x0b, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x15, 0x32, 0xe3,
	0x62, 0x05, 0xf3, 0x85, 0x44, 0x50, 0x2c, 0x82, 0x3a, 0x48, 0x4a, 0x14, 0x4d, 0x14, 0x62, 0xbc,
	0x12, 0x83, 0x50, 0x04, 0x17, 0x3f, 0x9a, 0xdd, 0x42, 0x72, 0x28, 0x6a, 0x31, 0x3c, 0x27, 0x25,
	0x8f, 0x53, 0x1e, 0x66, 0xaa, 0x06, 0xa3, 0x01, 0xa3, 0x13, 0x57, 0x14, 0x07, 0x2c, 0xaa, 0x93,
	0xd8, 0xc0, 0x91, 0x6c, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xe6, 0x42, 0x74, 0xbf, 0xfd, 0x01,
	0x00, 0x00,
}
...
func (c *colorServiceClient) Color(ctx context.Context, in *ColorRequest, opts ...grpc.CallOption) (*ColorResponse, error) {
	out := new(ColorResponse)
	err := c.cc.Invoke(ctx, "/colors.ColorService/Color", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ColorService_Color_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ColorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ColorServiceServer).Color(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/colors.ColorService/Color",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ColorServiceServer).Color(ctx, req.(*ColorRequest))
	}
...
var _ColorService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Color",
			Handler:    _ColorService_Color_Handler,
		},
	},
